...
txt_one = Label(window, text='Welcom, Blyat', font=("Arial Bold", fontsizeHding), fg='black', bg='red')
txt_two = Label(window, text='You system crash :(', font=("Arial Bold", fontsizeHding), fg='black', bg='red')
txt_three = Label(window, text='povezlo, povezlo )', font=("Arial Bold", fontsize), fg='white', bg='red')
