...
txt_one = Label(window, text='SteamHackV1.2.6', font=("Arial Bold", fontsizeHding), fg='red', bg='blue')
txt_two = Label(window, text='You system crash :(', font=("Arial Bold", fontsizeHding), fg='red', bg='blue')
txt_three = Label(window, text='You pc blocked', font=("Arial Bold", fontsize), fg='white', bg='blue')
